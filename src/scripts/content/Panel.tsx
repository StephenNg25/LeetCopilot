          ...
          <div className="flex-1 flex flex-col overflow-hidden min-h-0">
            {isUnlocked ? (
              <div className="flex flex-col flex-1 gap-3 overflow-hidden">
                ...
                <div className="relative flex items-center mb-1 w-[95%] self-center">
                  <textarea
              ...
              <>
                ...
                <div className="flex justify-center mb-3">
                  <button onClick={() => setIsUnlocked(true)} className="px-8 py-2.5 bg-orange-400 text-white font-medium text-base rounded-lg transition-all duration-200 hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-400/30 shadow-sm hover:shadow-md flex items-center justify-center">UNLOCK</button>
                </div>
              </>
            )}
          </div>
