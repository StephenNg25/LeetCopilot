export const generateHintPrompt = (hintLevel: number, problemContent: string) => {
    switch (hintLevel) {
      case 10:
        return `Here is a LeetCode problem description:\n${problemContent}\nI want a brute-force hint that gives a small nudge towards the solution without revealing it and going into code. Keep it to one or two sentences. This should be a hint for the most straightforward and easiest way of approaching. Mention the data structures or algorithms used for this approach.`;
      case 20:
