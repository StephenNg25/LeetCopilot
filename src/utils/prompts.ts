export const generateHintPrompt = (
  ...
  switch (hintLevel) {
    ...
    case 30:
      return `Here is a LeetCode problem description:\n${problemContent}\nGive a technical implementation detail hint for a brute-force or easiest way of approaching without revealing the entire code, in ${language}. Mention the time complexity and explain how the recommended data structure of this brute-force approach works. DO NOT recommend any other optimized solution. Give example walkthroughs to demonstrate and give better visualization.`;
    case 40:
      return `Here is a LeetCode problem description:\n${problemContent}\nGive a technical implementation detail hint for the most optimal way of approaching without revealing the entire code, in ${language}. Mention the time complexity and explain how the recommended data structure of this most optimized approach works. Give example walkthroughs to demonstrate and give better visualization.`;
      case 100:
        if (codeTemplate){
